...
class Wp_Fce
{
	...
	private function load_dependencies()
	{
		...
		require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-wp-fce-public-ajax.php';
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_action('wp_ajax_wp_fce_handle_admin_ajax_callback', $plugin_admin, 'register_ajax_handler');
		$this->loader->add_action('wp_ajax_nopriv_wp_fce_handle_admin_ajax_callback', $plugin_admin, 'register_ajax_handler');
	...
	private function define_public_hooks()
	{
		...
		//Register ajax handler
		$this->loader->add_action('wp_ajax_wp_fce_handle_public_ajax_callback', $plugin_public, 'register_ajax_handler');
		$this->loader->add_action('wp_ajax_nopriv_wp_fce_handle_public_ajax_callback', $plugin_public, 'register_ajax_handler');
